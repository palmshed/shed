...
export default defineConfig(
	...
	// vscode API
	{
		...
		rules: {
			...
			'local/shed-dts-create-func': 'warn',
			'local/shed-dts-literal-or-types': 'warn',
			'local/shed-dts-string-type-literals': 'warn',
			'local/shed-dts-interface-naming': 'warn',
			'local/shed-dts-cancellation': 'warn',
			'local/shed-dts-use-export': 'warn',
			'local/shed-dts-use-thenable': 'warn',
			'local/shed-dts-vscode-in-comments': 'warn',
			'local/shed-dts-provider-naming': [
				'warn',
				{
					'allowed': [
						'FileSystemProvider',
