...
const extensions = [
	...
	},
	{
		...
		extensionDevelopmentPath: `extensions/shed-api-tests`,
		workspaceFolder: `extensions/shed-api-tests/testWorkspace`,
		mocha: { timeout: 60_000 },
		files: 'extensions/shed-api-tests/out/singlefolder-tests/**/*.test.js',
	},
	{
		label: 'vscode-api-tests-workspace',
		extensionDevelopmentPath: `extensions/shed-api-tests`,
		workspaceFolder: `extensions/shed-api-tests/testworkspace.code-workspace`,
		mocha: { timeout: 60_000 },
		files: 'extensions/shed-api-tests/out/workspace-tests/**/*.test.js',
	},
	{
		label: 'git-base',
		mocha: { timeout: 60_000 }
