...
export const config = {
	...
	copyright: 'Copyright (C) 2026 Palmshed. All rights reserved',
	darwinExecutable: product.nameShort,
	darwinIcon: 'resources/darwin/shed.icns',
	darwinBundleIdentifier: product.darwinBundleIdentifier,
	darwinApplicationCategoryType: 'public.app-category.developer-tools',
	darwinHelpBookFolder: 'Shed HelpBook',
	darwinHelpBookName: 'Shed HelpBook',
	darwinBundleDocumentTypes: [
		...
		...darwinBundleDocumentTypes({
			...
			'Shed workspace file': 'code-workspace',
	...
	winIcon: 'resources/win32/shed.ico',
