...
AppPublisher=Palmshed
AppPublisherURL=https://github.com/palmshed
AppSupportURL=https://github.com/palmshed
AppUpdatesURL=https://github.com/palmshed
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=ShedSetup
Compression=lzma
...
SetupIconFile={#RepoDir}\resources\win32\shed.ico
...
Root: {#SoftwareClassesRootKey}; Subkey: "Software\Classes\{#RegValueName}.code-workspace\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#VersionedResourcesFolder}\resources\app\resources\win32\shed.ico"; Tasks: associatewithfiles
