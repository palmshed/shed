...
const codeEntryPoints = [
	'vs/shed/node/cliProcessMain',
	'vs/shed/electron-utility/sharedProcess/sharedProcessMain',
	'vs/shed/electron-browser/workbench/workbench',
...
const webEntryPoints = [
	...
	'vs/shed/browser/workbench/workbench',
];
...
const desktopResourcePatterns = [
	...
	'vs/shed/electron-browser/workbench/workbench-dev.html',
...
const serverWebResourcePatterns = [
	...
	// Web HTML
	'vs/shed/browser/workbench/workbench.html',
	'vs/shed/browser/workbench/workbench-dev.html',
	'vs/shed/browser/workbench/callback.html',
	'vs/workbench/services/extensions/worker/webWorkerExtensionHostIframe.html',
	'vs/workbench/contrib/webview/browser/pre/*.html',
...
async function compileStandaloneFiles(outDir: string, doMinify: boolean, target: BuildTarget): Promise<void> {
	...
	const banner = `/*!--------------------------------------------------------
 * Copyright (C) Palmshed. All rights reserved.
 *--------------------------------------------------------*/`;
