...
// overwrites legal/ThirdPartyNotices.txt BEFORE gulp packages it
// (build/gulpfile.vscode.ts reads 'legal/ThirdPartyNotices.txt' at package time).
//
...
//     used by 8+ pipelines). The legacy ThirdPartyNotices.txt in legal/ is
...
const TARGET_NOTICE = path.resolve('legal/ThirdPartyNotices.txt');
