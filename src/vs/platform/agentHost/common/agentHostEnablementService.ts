...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		'chat.editor.defaultProvider': {
			...
			enumDescriptions: [
				nls.localize('chat.editor.defaultProvider.local', "Use the built-in Shed local chat harness"),
		...
		'chat.editor.localAgent.enabled': {
			type: 'boolean',
			description: nls.localize('chat.editor.localAgent.enabled', "When enabled, shows the Shed local chat harness in the chat picker. This setting is ignored in virtual workspaces, where the local chat harness is always available."),
			default: true,
			tags: ['experimental'],
			experiment: { mode: 'startup' },
		},
