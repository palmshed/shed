...
export class NativeHostMainService extends Disposable implements INativeHostMainService {
	...
	private get cliPath(): string {
		...
		if (isWindows) {
			...
			return join(this.environmentMainService.appRoot, 'scripts', 'shed-cli.bat');
		}
		...
		if (isLinux) {
			...
			return join(this.environmentMainService.appRoot, 'scripts', 'shed-cli.sh');
		}

		// macOS
		if (this.environmentMainService.isBuilt) {
			return join(this.environmentMainService.appRoot, 'bin', 'shed');
		}
