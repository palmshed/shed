						...
						translations: {
							...
							items: {
								...
								properties: {
									id: {
										type: 'string',
										description: localize('vscode.extension.contributes.localizations.translations.id', "Id of Shed or Extension for which this translation is contributed to. Id of Shed is always `shed` and of extension should be in format `publisherId.extensionName`."),
