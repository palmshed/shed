...
suite('Decoration Render Options', () => {
	...
	const options: IDecorationRenderOptions = {
		gutterIconPath: URI.parse('https://github.com/microsoft/vscode/blob/main/resources/linux/shed.png'),
	...
	test('css properties', () => {
		...
		assert(sheet.indexOf(`{background:url('${CSS.escape('https://github.com/microsoft/vscode/blob/main/resources/linux/shed.png')}') center center no-repeat;background-size:contain;}`) >= 0);
