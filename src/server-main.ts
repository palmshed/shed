...
(globalThis as { shedServerStartTime?: number }).shedServerStartTime = performance.now();
...
if (shouldSpawnCli) {
	...
	server.listen(nodeListenOptions, async () => {
		...
		(globalThis as { shedServerListenTime?: number }).shedServerListenTime = performance.now();
